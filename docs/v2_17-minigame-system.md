...
- Start time now uses TimeEnergySystem.GetCurrentTime.
- Only ClickTargets is implemented; other minigames are StubMinigame.
- UI creation remains TODO; input is gated behind legacy input.
