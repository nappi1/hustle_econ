...
- GenerateRelationshipEvents now uses RelationshipSystem.GetNPC and avoids creating duplicates.
- AttendEvent now calls ObservePlayerAction(AttendedEvent).
- Event minigame creation remains TODO.
