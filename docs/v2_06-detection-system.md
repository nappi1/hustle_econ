...
- SetPatrolFrequency and SetDetectionSensitivity are implemented and wired from HeatSystem.
- CheckDetection uses activityId with test overrides for activity data.
