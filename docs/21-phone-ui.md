...
- `RelationshipSystem.GetNPCs(playerId)` - Contacts list ⚠️ MISSING API (line 10)
...
private string GetNPCName(string npcId) {
    // ⚠️ REQUIRES: RelationshipSystem.GetNPC(npcId) - currently missing (line 10)
...
private void RefreshContactsList() {
    // ⚠️ REQUIRES: RelationshipSystem.GetNPCs(playerId) - currently missing (line 10)
...
│  Messages Bank Cal  │
│                     │
│  [💊] [📞] [⚙️]     │  Row 2: Drugs, Contacts, Settings
│  Deals Cont. Set.   │
│                     │
