...
- TriggerWarning(playerId, ...) exists; job-level warnings use TriggerWarningForJob.
- GetCurrentJob/GetJobById/HasJob are implemented.
- No explicit JobSystem->ActivitySystem integration for minigame performance beyond ActivitySystem calls.
