...
- GetNPC/GetNPCs exist; GetNPCsByType is not implemented.
- NPC.bodyPreferences and PlayerAction.isPositive exist but are not actively used.
- AttendedEvent action exists but currently has zero impact to avoid double counting.
