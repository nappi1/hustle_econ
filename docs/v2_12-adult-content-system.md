...
- Blackmail uses ExpenseType.Blackmail; escort income uses IncomeSource.SexWork; sugar allowance uses IncomeSource.SugarRelationship.
- CriminalRecord/Event/Job consequences remain TODOs.
